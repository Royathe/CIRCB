...
using System.Linq;
using CIRCBot.Apis.Repositories;
...
namespace CIRCBot.Apis
{
    ...
    public class OpenWeatherAPI
    {
        ...
        {
            Key = key;//System.Configuration.ConfigurationManager.AppSettings["OpenWeatherAPI"];
        }
        ...
        public Weather NextForecast(DateTime date, string cityname = "", string country = "")
        {
            ...
            string forecastJSON = Utils.GetJSONResponse(
        ...
        public Weather CurrentWeather(string cityname = "", string country = "")
        {
            ...
            string weatherJSON = Utils.GetJSONResponse(
